...
- [singchia/geminio](https://github.com/singchia/geminio) - An application layer networking framework with rpc, bidirectional-rpc, multiplexer, raw-io and client-server consistency.
